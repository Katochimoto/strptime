...
describe('strftime', function() {
    ...
    it('%Date_dBA', function() {
        ...
        expect(d.getTime()).to.be(Date.UTC(1900, 10, 2, 0, 0, 0, 0));
    });

    it('%Date_df_in_HM', function() {
        var d = strptime('nov., 2 at 22:30', '%Date_df_in_HM');

        expect(d.getTime()).to.be(Date.UTC(1900, 10, 2, 22, 30, 0, 0));
    });
    ...
    it('%Date_dB_in_HM', function() {
        ...
        expect(d.getTime()).to.be(Date.UTC(1900, 10, 2, 22, 32, 0, 0));
    });
    ...
    it('%Date_iso', function() {
        ...
        expect(d.getTime()).to.be(Date.UTC(2013, 10, 2, 22, 34, 21, 0));
    });
    ...
    it('%Date_FT', function() {
        ...
        expect(d.getTime()).to.be(Date.UTC(2013, 10, 2, 22, 36, 5, 0));
    });
    ...
    it('%b', function() {
        ...
        expect(d.getTime()).to.be(Date.UTC(1900, 10, 1, 0, 0, 0, 0));
    });
    ...
    it('%g', function() {
        ...
        expect(d.getTime()).to.be(Date.UTC(2013, 0, 1, 0, 0, 0, 0));
    });
    ...
    it('%d', function() {
        ...
        expect(d.getTime()).to.be(Date.UTC(1900, 0, 2, 0, 0, 0, 0));
    });
    ...
    it('%H', function() {
        ...
        expect(d.getTime()).to.be(Date.UTC(1900, 0, 1, 22, 0, 0, 0));
    });

    it('%I', function() {
        var d = strptime('5 PM', '%I %p');

        expect(d.getTime()).to.be(Date.UTC(1900, 0, 1, 17, 0, 0, 0));

        d = strptime('5 AM', '%I %p');

        expect(d.getTime()).to.be(Date.UTC(1900, 0, 1, 5, 0, 0, 0));
    });
    ...
    it('%M', function() {
        ...
        expect(d.getTime()).to.be(Date.UTC(1900, 0, 1, 0, 1, 0, 0));
    });

    it('%S', function() {
        var d = strptime('01', '%S');

        expect(d.getTime()).to.be(Date.UTC(1900, 0, 1, 0, 0, 1, 0));
    });
    ...
    it('%z', function() {
        ...
        expect(d.getTime()).to.be(Date.UTC(1900, 0, 1, 1, 0, 0, 0));
    });
